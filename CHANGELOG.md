# Release Notes for Taskify Business 1.10.5 (January Security Patch)

# Stack Upgrades
- supabase-js `2.93.3`
  - [New in 2.93.3](https://github.com/supabase/supabase-js/releases/tag/v2.93.3)
...
- Electron `40.1.0`
  - [New in 40.0.0](https://github.com/electron/electron/releases/tag/v40.1.0)

# ⚠️Warning
This version of Taskify Business **resolves important security vulnerabilities** caused by packages used by the application that were not updated correctly. This update is recommended for all users as part of the **January Security Patch.**
